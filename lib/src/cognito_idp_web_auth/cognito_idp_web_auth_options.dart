...
/// Options that control how a web authentication session behaves.
///
/// Based on [FlutterWebAuth2Options] from `flutter_web_auth_2`.
/// Licensed under the same terms as that package.
///
/// Default intent flags for opening the custom tabs intent on Android.
/// This is essentially the same as
/// `FLAG_ACTIVITY_SINGLE_TOP | FLAG_ACTIVITY_NEW_TASK`.
const int defaultIntentFlags = 1 << 29 | 1 << 28;

/// "Ephemeral" intent flags for opening the custom tabs intent on Android.
/// This is essentially the same as
/// `FLAG_ACTIVITY_SINGLE_TOP | FLAG_ACTIVITY_NEW_TASK
/// | FLAG_ACTIVITY_NO_HISTORY`.
const int ephemeralIntentFlags = defaultIntentFlags | 1 << 30;

/// Default HTML code that generates a nice callback page.
const String _defaultLandingPage = '''
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
class CognitoIdpWebAuthOptions {
  /// Construct an instance and specify the wanted options.
  const CognitoIdpWebAuthOptions({
  ...
  CognitoIdpWebAuthOptions.fromJson(Map<String, dynamic> json)
    : this(
  ...
  CognitoIdpWebAuthOptions copyWith({
    bool? preferEphemeral,
    String? debugOrigin,
    int? intentFlags,
    String? windowName,
  ...
  }) => CognitoIdpWebAuthOptions(
    preferEphemeral: preferEphemeral ?? this.preferEphemeral,
    debugOrigin: debugOrigin ?? this.debugOrigin,
    intentFlags: intentFlags ?? this.intentFlags,
    windowName: windowName ?? this.windowName,
    timeout: timeout ?? this.timeout,
    landingPageHtml: landingPageHtml ?? this.landingPageHtml,
    silentAuth: silentAuth ?? this.silentAuth,
    useWebview: useWebview ?? this.useWebview,
    httpsHost: httpsHost ?? this.httpsHost,
    httpsPath: httpsPath ?? this.httpsPath,
    customTabsPackageOrder: customTabsPackageOrder ?? this.customTabsPackageOrder,
  );

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is CognitoIdpWebAuthOptions &&
          runtimeType == other.runtimeType &&
          preferEphemeral == other.preferEphemeral &&
          debugOrigin == other.debugOrigin &&
          intentFlags == other.intentFlags &&
          windowName == other.windowName &&
          timeout == other.timeout &&
          landingPageHtml == other.landingPageHtml &&
          silentAuth == other.silentAuth &&
          useWebview == other.useWebview &&
          httpsHost == other.httpsHost &&
          httpsPath == other.httpsPath &&
          listEquals(customTabsPackageOrder, other.customTabsPackageOrder);

  @override
  int get hashCode =>
      preferEphemeral.hashCode ^
      debugOrigin.hashCode ^
      intentFlags.hashCode ^
      windowName.hashCode ^
      timeout.hashCode ^
      landingPageHtml.hashCode ^
      silentAuth.hashCode ^
      useWebview.hashCode ^
      httpsHost.hashCode ^
      httpsPath.hashCode ^
      (customTabsPackageOrder?.hashCode ?? 0);
}
